...
<form class="layui-form" id="frm" method="post" action="${pageContext.request.contextPath }/login/login">
    ...
    <div class="layui-form-item input-item">
        ...
        <input  id="userName" type="text" placeholder="请输入用户名"  autocomplete="off" name="user_name" class="layui-input" lay-verify="required">
    ...
    <div class="layui-form-item input-item">
        ...
        <input  id="password" type="password" placeholder="请输入密码"  autocomplete="off" name="user_pswd" class="layui-input" lay-verify="required">
